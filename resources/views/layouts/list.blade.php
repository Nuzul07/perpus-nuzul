    ...
    <div id="app">  
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a href="/admin" class="side-link waves-effect">
                            <i class="fa fa-home"></i>
                            <span>Dashboard</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('admin/buku') }}" class="side-link waves-effect">
                            <i class="fa fa-book"></i>
                            <span>Data Buku</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('admin/stokbuku') }}" class="side-link waves-effect">
                            <i class="fa fa-store"></i>
                            <span>Stok Buku</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('admin/user') }}" class="side-link waves-effect">
